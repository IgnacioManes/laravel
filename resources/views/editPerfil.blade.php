                    ...
                    <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="nombre" type="text" class="form-control" name="nombre"
                                   value="{{(old('nombre'))?old("nombre"):$empleado->nombre }}" required>
                    ...
                    <div class="form-group{{ $errors->has('apellido') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="apellido" type="text" class="form-control" name="apellido"
                                   value="{{ old('apellido')?old("apellido"):$empleado->apellido  }}" required>
                    ...
                    <div class="form-group{{ $errors->has('documento') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input id="documento" type="text" class="form-control" name="documento"
                                   value="{{ old('documento') ?old("documento"):$empleado->documento}}" required>
